...
public:
	...
	//组合多维函数
	static LONG wps(WindData& outWindData, LPCWSTR portfolioName, LPCWSTR fields, LPCWSTR options = NULL);

	//组合序列函数
	static LONG wpd(WindData& outWindData, LPCWSTR portfolioName, LPCWSTR fields, LPCWSTR beginTime = NULL, LPCWSTR endTime = NULL, LPCWSTR options = NULL);

	//代码转换函数
	LONG htocode(WindData& outWindData, LPCWSTR windCodes, LPCWSTR sec_type, LPCWSTR options = NULL);
